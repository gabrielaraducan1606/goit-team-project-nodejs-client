...
// import React, { useState } from "react";
// import { createBoard } from "../services/userServices"; 
// import LogoComponent from "./LogoComponent";
// import HelpSection from "./HelpSection";
// import LogoutButton from "./LogoutButton";
// import Button from "./button";
...
//       <aside className="w-64 h-full p-4 flex flex-col bg-sidebar-bg text-text">
//         <LogoComponent />
//         <h3 className="text-sm mb-0 mt-[60px] text-[12px] font-thin text-gray-400">My boards</h3>
...
//       {/* NEW BOARD MODAL */}
//       <BackupModal size="md" open={createBoardOpen} closeModal={() => setCreateBoardOpen(false)}>
//         <h4 className="mb-6">New Board</h4>
...
//                   />
//                   <CustomSvg id={icon.id} href={icon.href} className="size-5 stroke-icon peer-checked:stroke-icon-selected" />
//                 </label>
//               ))}
//             </div>
//           </div>
...
//                   />
//                   <img src={background.src} alt={background.name} className="peer-checked:shadow-lg shadow-primary" />
//                 </label>
//               ))}
//             </div>
//           </div>
