...
const Board = () => {
  ...
  const handleColumnSubmit = async (e) => {
    ...
    if (columnMode === "edit" && editingColumnId) {
      const response = await updateColumn(editingColumnId, {
        title: columnTitle,
      });
  ...
  return (
    <>
      ...
      <BackupModal size="md" open={columnModalOpen} closeModal={resetModal}>
        <h4 className="mb-4">
          {columnMode === "edit" ? "Edit column" : "Add column"}
        </h4>
